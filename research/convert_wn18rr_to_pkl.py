#!/usr/bin/env python3
"""
Convert WN18RR dataset into a single .pkl file compatible with skge hole run.
...
def main():
    ...
    p.add_argument('--data-dir', '-d', required=True, help='Directory with WN18RR files (train.txt, valid.txt, test.txt)')
    p.add_argument('--out', '-o', default='data/wn18rr.pkl', help='Output pickle file')
    args = p.parse_args()
