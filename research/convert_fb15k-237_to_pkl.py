#!/usr/bin/env python3
"""
Convert FB15k-237 dataset into a single .pkl file compatible with skge hole run.
...
def main():
    ...
    p.add_argument('--data-dir', '-d', default='data/FB15k-237', help='Directory with FB15k-237 files (train.txt, valid.txt, test.txt)')
    p.add_argument('--out', '-o', default='data/fb15k-237.pkl', help='Output pickle file')
    args = p.parse_args()
