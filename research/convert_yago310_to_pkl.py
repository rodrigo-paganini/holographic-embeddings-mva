#!/usr/bin/env python3
"""
Convert YAGO3-10 dataset into a single .pkl file compatible with skge hole run.
...
def main():
    ...
    p.add_argument('--data-dir', '-d', default='data/YAGO3-10', help='Directory with YAGO3-10 files (train.txt, valid.txt, test.txt)')
    p.add_argument('--out', '-o', default='data/yago310.pkl', help='Output pickle file')
    args = p.parse_args()
